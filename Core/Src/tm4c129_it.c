...
void EXTI_GPIOM_IRQHandler(void)
{
	uint32_t IntPins=GPIOIntStatus(GPIO_PORTM_BASE,false);
...
void I2C4_IntHandler(void)
{
	I2CMIntHandler(&I2C4Inst);
}
void I2C5_IntHandler(void)
{
	I2CMIntHandler(&I2C5Inst);
}
